...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/ngsi/ngsiParser.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/ngsi/ngsiParser.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/ngsi/</a> &#187; ngsiParser.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!idNodes || idNodes.length !== 1) {
<span class="cstat-no" title="statement not covered" >        callback(new errors.BadRequest('Error parsing XML: context id not found'));</span>
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (attributeNames.length === 1) {
            attribute.name = attributeNames.item(0).firstChild.nodeValue;
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (attributeTypes.length === 1) {
            attribute.type = attributeTypes.item(0).firstChild.nodeValue;
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (attributeValues.length === 1) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!entityIdNodes || entityIdNodes.length !== 1) {
<span class="cstat-no" title="statement not covered" >        callback(new errors.BadRequest('Error parsing XML: context element not found'));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
&nbsp;
    async.parallel([
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (updateActionNodes.length !== 1) {
<span class="cstat-no" title="statement not covered" >            callback(new errors.BadRequest('Error parsing XML: update action element not found'));</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
...
&nbsp;
    function createUpdateBody(error, results) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (error) {
<span class="cstat-no" title="statement not covered" >            logger.debug(context, 'Error parsing XML Update Context body: %s', error);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            callback(error);</span>
        } else {
            var element = {
...
&nbsp;
    function createQueryBody(error, results) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (error) {
<span class="cstat-no" title="statement not covered" >            logger.debug(context, 'Error parsing XML Query Context body: %s', error);</span>
<span class="cstat-no" title="statement not covered" >            callback(error);</span>
        } else {
            var element = {
                entities: results[0],
