...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/common/securityService.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/common/securityService.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/common/</a> &#187; securityService.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            logger.error(context, 'Error retrieving token from Keystone: %s', error);</span>
<span class="cstat-no" title="statement not covered" >            callback(new errors.TokenRetrievalError(trust, error));</span>
        ...
        } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (response.statusCode === 401) {
            logger.error(context, 'Authentication rejected: %s', trust);
            callback(new errors.AuthenticationError(trust));
        } else {
<span class="cstat-no" title="statement not covered" >            logger.error(context, 'Unexpected status code: %d', response.statusCode);</span>
<span class="cstat-no" title="statement not covered" >            callback(new errors.TokenRetrievalError(</span>
...
&nbsp;
/**
 * Initializes the Security Service, injecting the config object.
 *
