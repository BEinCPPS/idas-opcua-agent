...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/common/iotManagerService.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/common/iotManagerService.js</span></h1>
    <h2>
        
        Statements: <span class="metric">86.49% <small>(32 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/common/</a> &#187; iotManagerService.js</div>
</div>
<div class="body">
...
&nbsp;
    function getServices(callback) {
        serviceRegistry.list(null, null, null, function(error, results) {
    ...
    function sendRegistration(services, callback) {
        var options = {
            ...
            json: {
                ...
                iotagent: config.providerUrl + '/iot',
...
&nbsp;
    function handleRegistration(result, body, callback) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (result.statusCode !== 200 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >result.statusCode !== 201)</span> {
<span class="cstat-no" title="statement not covered" >            logger.error(context, 'Error updating information in the IOTAM. Status Code [%d]', result.statusCode);</span>
        }
&nbsp;
        callback();
    }
&nbsp;
    function checkConfiguration(callback) {
        var attributes = ['protocol', 'description', 'defaultResource'],
            missing = [];
&nbsp;
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (!config.providerUrl) {
<span class="cstat-no" title="statement not covered" >            missing.push('providerUrl');</span>
        }
&nbsp;
        for (var i in attributes) {
            <span class="missing-if-branch" title="if path not taken"" >I</span>if (!config.iotManager[attributes[i]]) {
<span class="cstat-no" title="statement not covered" >                missing.push(attributes[i]);</span>
            }
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (missing.length) {
<span class="cstat-no" title="statement not covered" >            callback(new errors.MissingConfigParams(missing));</span>
        } else {
            callback();
        }
    }
