...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/groups/groupService.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/groups/groupService.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/groups/</a> &#187; groupService.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        callback = service;</span>
    }
&nbsp;
    registry.list(service, limit, offset, callback);
}
&nbsp;
 ...
 * @param {String} apikey               Api keys the devices will declare.
 */
<span class="fstat-no" title="function not covered" >function getGroup(resource, apikey, callback) {</span>
<span class="cstat-no" title="statement not covered" >    registry.get(resource, apikey, callback);</span>
}
&nbsp;
/**
