...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/groups/groupRegistryMemory.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/groups/groupRegistryMemory.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/groups/</a> &#187; groupRegistryMemory.js</div>
</div>
<div class="body">
...
&nbsp;
    for (var i in filteredGroups) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (registeredGroups.hasOwnProperty(filteredGroups[i])) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function init(newConfig, callback) {</span>
...
&nbsp;
    for (var i in registeredGroups) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (registeredGroups.hasOwnProperty(i) &amp;&amp;
...
<span class="cstat-no" title="statement not covered" >        callback(new errors.DeviceGroupNotFound(service, subservice));</span>
    }
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (groupToModify) {
        for (var i in body) {
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (body.hasOwnProperty(i)) {
...
<span class="cstat-no" title="statement not covered" >        callback(new errors.DeviceGroupNotFound(id));</span>
    }
}
&nbsp;
