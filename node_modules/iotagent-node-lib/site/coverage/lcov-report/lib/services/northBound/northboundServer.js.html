...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/northBound/northboundServer.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/services/northBound/northboundServer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">80% <small>(44 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/northBound/</a> &#187; northboundServer.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function traceRequest(req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >    logger.debug(context, 'Request for path [%s] from [%s]', req.path, req.get('host'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (req.is('json')) {</span>
<span class="cstat-no" title="statement not covered" >        logger.debug(context, 'Body:\n\n%s\n\n', JSON.stringify(req.body, null, 4));</span>
    } else <span class="cstat-no" title="statement not covered" >if (req.is('xml')) {</span>
<span class="cstat-no" title="statement not covered" >        logger.debug(context, 'Body:\n\n%s\n\n', req.rawBody);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        logger.debug(context, 'Unrecognized body type', req.headers['content-type']);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    next();</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function retrieveVersion(req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >    res.status(200).json(iotaInformation);</span>
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (config.logLevel &amp;&amp; config.logLevel === 'DEBUG') {
<span class="cstat-no" title="statement not covered" >        northboundServer.app.use(traceRequest);</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (config.iotaVersion) {
<span class="cstat-no" title="statement not covered" >        iotaInformation.version = config.iotaVersion;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (northboundServer) {
