...
<html lang="en">
<head>
    <title>Code coverage report for lib/model/dbConn.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/model/dbConn.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/model/</a> &#187; dbConn.js</div>
</div>
<div class="body">
...
&nbsp;
    defaultDb.on('error', <span class="fstat-no" title="function not covered" >function mongodbErrorHandler(error) {</span>
