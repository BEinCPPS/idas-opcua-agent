...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/compressTimestamp.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/plugins/compressTimestamp.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/plugins/</a> &#187; compressTimestamp.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (split) {
...
&nbsp;
exports.update = pluginUtils.createUpdateFilter(fromBasicToExtended, 'timestamp');
exports.query = pluginUtils.createQueryFilter(fromExtendedToBasic, 'timestamp');
&nbsp;</pre></td></tr>
</table></pre>
