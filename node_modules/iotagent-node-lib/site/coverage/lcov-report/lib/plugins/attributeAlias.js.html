...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/attributeAlias.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/plugins/attributeAlias.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/plugins/</a> &#187; attributeAlias.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (typeInformation.active) {
        mappings = typeInformation.active.reduce(extractSingleMapping, mappings);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (typeInformation.lazy) {
        mappings = typeInformation.lazy.reduce(extractSingleMapping, mappings);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (typeInformation.commands) {
...
function applyAlias(mappings) {
    return function aliasApplier(attribute) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (mappings.direct[attribute.name]) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function queryAttribute(entity, typeInformation, callback) {</span>
<span class="cstat-no" title="statement not covered" >    callback(null, entity, typeInformation);</span>
}
&nbsp;
