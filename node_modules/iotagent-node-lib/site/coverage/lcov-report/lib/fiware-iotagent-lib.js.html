...
<html lang="en">
<head>
    <title>Code coverage report for lib/fiware-iotagent-lib.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/fiware-iotagent-lib.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">97.06% <small>(66 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; fiware-iotagent-lib.js</div>
</div>
<div class="body">
...
var async = require('async'),
    ...
    security = require('./services/common/securityService'),
...
function activateStatLogs(newConfig, callback) {
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (newConfig.stats &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >newConfig.stats.interval)</span> {
 ...
 */
<span class="fstat-no" title="function not covered" >function globalErrorHandler(err) {</span>
<span class="cstat-no" title="statement not covered" >    logger.fatal('An unexpected exception has been raised. Ignoring: %s', err);</span>
}
&nbsp;
/**
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (!config.dieOnUnexpectedError) {
...
&nbsp;
    async.series([
        ...
        apply(subscriptions.init, registry, newConfig),
