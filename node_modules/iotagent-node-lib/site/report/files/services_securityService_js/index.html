...
<div class="jumbotron">
  <div class="container">
    <h1>services/securityService.js</h1>
  </div>
</div>
...
function getToken(trust, callback) {
    ...
    request(options, function handleResponse(error, response, body) {
        if (error) {
            logger.error(context, &#039;Error retrieving token from Keystone: %s&#039;, error);
            ...
            logger.error(context, &#039;Unexpected status code: %d&#039;, response.statusCode);
